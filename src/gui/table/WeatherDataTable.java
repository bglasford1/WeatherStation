/*
  ...
  Purpose:	This class is responsible for drawing the raw weather data table.
            These are the interval records saved to the database.  This data
            can be modified.  A string value of "---" means no data is available.
            In many cases the DB native value stored is 0x8000.
...
public class WeatherDataTable extends JPanel implements TableModelListener
{
  ...
  public void createTable(int year, int month)
  {
    ...
    {
      logger.logData("WeatherDataTable: createTable: Unable to read data: " + e.getLocalizedMessage());
      return;
    }
    ...
    while (nextRecord != null)
    {
      if (nextRecord instanceof WeatherRecord)
      {
        ...
        {
          System.out.println("WeatherDataTable: error in dataset." + exc);
        }
      }
  ...
  public static void createAndShowGUI(JPanel dataTable)
  {
    ...
    JFrame frame = new JFrame("Weather Data Table");
